...
/* ────────────────────────────────────────────────────────────
   Propuesta — Ford Rivera × PG Estrategias.

   Misma iguala, mismos entregables y mismo precio que la propuesta de
   Autonación, adaptada a Ford Rivera. La mensajería masiva sale del
   paquete base: se ofrece como bono si se cierra por 6 meses.
   ──────────────────────────────────────────────────────────── */

const CLIENTE = "Ford Rivera";
const PRECIO = "15,000";
...
const MUESTRAS: Slot[] = [
  { src: V_FORD, label: "Ford Rivera · demo" },
...
/* Los espacios que se llenan con material de Ford Rivera. Van como fichas
...
/* Lo que se produce cada mes y lo que entra bajo la iguala sin costo
   extra: es el punto de partida de esta propuesta, así que va como
   bloque propio. */
const SE_PRODUCE = ["Calendario de contenido", "Campaña en Meta Ads"];
...
const FRENTES = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Landing de oferta para tráfico pagado",
    ],
...
export default function PropuestaFordRiveraClient() {
  ...
  return (
    <>
      ...
      <main style={{ background: "#1C1C1A", color: "#E4E0DD" }}>
        ...
        >
          ...
          <div className="relative z-10 w-full px-6 md:px-14 pt-28 pb-14 md:pb-16 max-w-[1400px] mx-auto">
            ...
            <div className="overflow-hidden max-w-[1100px]">
              ...
              >
                Cada Ford que entra a exhibición{" "}
                <em style={{ color: "#D63A27", fontStyle: "italic" }}>
                  pide producción a su altura.
                </em>
              </motion.h1>
            </div>
            <motion.p
            ...
            >
              La producción y la estrategia comercial van a la par: contenido que
              le hace justicia a cada unidad y campañas que lo convierten en
              tráfico a piso.
            </motion.p>
          </div>
        </section>
        ...
        {/* ============================================================
            2 · LO QUE SE PRODUCE / LO QUE SE SUMA
           ============================================================ */}
        ...
        <section className="relative py-20 md:py-28" style={{ background: "#151513" }}>
          <div className="px-6 md:px-14 max-w-[1400px] mx-auto">
            ...
            <motion.p
              ...
              style={{ color: "rgba(228,224,221,0.5)" }}
            >
              Si Ford Rivera colabora con un influencer automotriz, producimos el
        ...
        <section className="relative px-6 md:px-14 py-20 md:py-28 max-w-[1400px] mx-auto">
          ...
          <motion.div {...reveal} className="mt-14 md:mt-16">
            <p
              ...
              style={{ color: "rgba(228,224,221,0.5)" }}
            >
              Lo que grabamos con Ford Rivera el primer mes
            </p>
          ...
          <div className="relative max-w-[1200px] mx-auto">
            ...
            >
              ...
              >
                ...
                línea aparte si Ford Rivera lo requiere. Los 4 levantamientos al
            ...
            >
              ...
              <p
                ...
                style={{ color: "rgba(228,224,221,0.7)" }}
              >
                Si cerramos por 6 meses, sumamos sin costo extra la gestión de
        ...
        >
          ...
          <div className="relative z-10 max-w-[900px] mx-auto text-center">
            ...
            >
              Arrancamos con el calendario del primer mes.
            </motion.p>
            <motion.div
              {...reveal}
