...
/* ────────────────────────────────────────────────────────────
   Propuesta general — Médicos y clínicas × PG Estrategias.

   Propuesta de catálogo, no a medida: tres bloques —lo que hacemos por
   ti, lo que ya hemos producido, y quién lo respalda— sobre el paquete
   Ignición tal como está publicado en el sitio.

   Los testimonios hablan del servicio de la agencia, nunca de
   tratamientos ni resultados clínicos, que es lo que permite usarlos sin
   caer en publicidad sanitaria.
   ──────────────────────────────────────────────────────────── */

const CLIENTE = "Médicos y clínicas";
const PRECIO = "11,000";
const PAUTA = "$2,500";
...
const MUESTRAS = [
  {
    src: "https://res.cloudinary.com/djduba5fd/video/upload/v1779377487/AronZarainLandingPage_femgcw.mp4",
    label: "Página de ventas",
  },
  {
    src: "https://res.cloudinary.com/djduba5fd/video/upload/v1779379265/Webinar_yvswzj.mp4",
    label: "Webinar",
  },
  {
    src: "https://res.cloudinary.com/djduba5fd/video/upload/v1788051909/DemoMercedes_csof2x.mp4",
    label: "Automotriz",
  },
];

/* Testimonios del sitio. Abre el de proctología por ser el del mismo
   gremio al que va dirigida esta propuesta. */
const TESTIMONIOS = [
  {
    video:
...
const DOLORES = [
  "Pacientes que preguntan y nunca agendan.",
  "Depender de referidos y de que el mes venga bueno.",
  "Una competencia que se ve mejor, no que atiende mejor.",
];
...
export default function PropuestaMedicosClient() {
      ...
      <main style={{ background: "#1C1C1A", color: "#E4E0DD" }}>
        ...
        >
          ...
          <div className="relative z-10 w-full px-6 md:px-14 pt-28 pb-14 md:pb-16 max-w-[1400px] mx-auto">
            ...
            >
              ...
              >
                Para consultorios y clínicas · PG Estrategias
              </p>
            </motion.div>
            <div className="overflow-hidden max-w-[1100px]">
              ...
              >
                Tu experiencia ya convence. Falta que te encuentren.
              </motion.h1>
            </div>
            <motion.p
            ...
            >
              Anuncios, video y una página que agenda, operados por un solo
        ...
        <section className="relative px-6 md:px-14 py-20 md:py-24 max-w-[1400px] mx-auto">
          <motion.div {...reveal} className="mb-10 max-w-[820px]">
            <Eyebrow>Lo que vemos en consultorios</Eyebrow>
            <SectionTitle>
              El paciente te busca en Google y encuentra a otro.
            </SectionTitle>
          </motion.div>
          ...
          <div className="relative max-w-[1200px] mx-auto">
            ...
            >
              <div className="lg:col-span-5">
                ...
                >
                  Todo lo que necesita un consultorio para empezar a llenar
                  agenda, bajo un solo cargo mensual y un solo equipo.
                </p>
        ...
        <section className="relative px-6 md:px-14 py-20 md:py-28 max-w-[1400px] mx-auto">
          <motion.div {...reveal} className="mb-10 md:mb-14 max-w-[820px]">
            ...
            <p
              ...
              style={{ color: "rgba(228,224,221,0.72)" }}
            >
              Producimos para concesionarias premium, para consultorios y para
              negocios de servicio. Cambia el guion; no cambia el nivel de
              producción.
            </p>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 max-w-[900px] mx-auto text-center">
            ...
            >
              20 minutos para saber si podemos llenar tu agenda.
            </motion.h2>
            <motion.p
              {...reveal}
              ...
              style={{ color: "rgba(228,224,221,0.7)" }}
            >
              Sin costo. Si no somos la opción correcta para tu consultorio, te
