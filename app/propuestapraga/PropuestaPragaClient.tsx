...
/* ────────────────────────────────────────────────────────────
   Propuesta — Praga × PG Estrategias.
...
/* Lo que se graba en Praga el primer mes. */
const RESERVADOS = [
  "Recap de la noche de Halloween",
  "Sesión editorial “Catrinas de Praga”",
...
const GUION = [
  ...
  { t: "7–11 s", img: "Caminan por calle poblana hacia el neón de Praga, se acomodan el saco (IA)", txt: "Entra la música" },
  { t: "11–15 s", img: "Interior real grabado: luces, barra, brindis", txt: "—" },
  { t: "15–18 s", img: "Logo Praga + fecha del evento", txt: "Remate" },
];
...
const IDEAS = [
  ...
  {
    tag: "04",
    name: "El Buen Fin de Praga",
    when: "Mediados de noviembre",
    body: "Promoción de temporada (2×1 en botella, cover libre o mesa con descuento — la definimos juntos) anunciada por mensajería masiva a la base de contactos y reforzada con pauta ese fin de semana. Mientras todo el mundo compra pantallas, Praga vende la noche.",
  },
  {
    tag: "05",
...
export default function PropuestaPragaClient() {
      ...
      <main style={{ background: "#1C1C1A", color: "#E4E0DD" }}>
        ...
        >
          ...
          <div className="relative z-10 w-full px-6 md:px-14 pt-28 pb-14 md:pb-16 max-w-[1400px] mx-auto">
            ...
            <div className="overflow-hidden max-w-[1100px]">
              ...
              >
                La noche en Puebla tiene nombre.{" "}
        ...
        <section className="relative px-6 md:px-14 py-20 md:py-28 max-w-[1400px] mx-auto">
          <motion.div {...reveal} className="mb-10 md:mb-14 max-w-[820px]">
            ...
            >
              ...
              producción que llevamos a la noche de Praga.
            </p>
          </motion.div>
          ...
          <motion.div {...reveal} className="mt-14 md:mt-16">
            <p
              ...
              style={{ color: "rgba(228,224,221,0.5)" }}
            >
              Lo que grabamos en Praga el primer mes
            </p>
        ...
        <section className="relative px-6 md:px-14 py-20 md:py-28 max-w-[1400px] mx-auto">
          <motion.div {...reveal} className="mb-12 md:mb-14 max-w-[860px]">
            <Eyebrow>Ideas para Praga · 01</Eyebrow>
            <SectionTitle>
              “Hasta los muertos{" "}
              <em style={{ color: "#D63A27", fontStyle: "italic" }}>
                se levantan.”
            ...
            >
              ...
              se acomodan el traje y caminan por las calles de Puebla hasta un
              letrero de neón: Praga. Corte a tomas reales del interior — luces,
              barra, brindis.
            </p>
            <p
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            {[
              ...
              },
              {
                ...
                v: "“Hasta los muertos se levantan por venir a Praga.”",
        ...
        <section className="relative py-20 md:py-28" style={{ background: "#151513" }}>
          <div className="px-6 md:px-14 max-w-[1400px] mx-auto">
            <motion.div {...reveal} className="mb-12 md:mb-16 max-w-[760px]">
              <Eyebrow>Ideas para Praga · Octubre y Noviembre</Eyebrow>
              <SectionTitle>
