...
/* ────────────────────────────────────────────────────────────
   Landing de propuesta — Autonación × PG Estrategias.

   Se presenta en persona al jefe de marketing: NO lleva botones,
   enlaces de contacto ni precios. El cierre es verbal y la última
   pantalla es el telón de fondo de ese cierre, por eso tampoco
   monta el Footer del sitio.
   ──────────────────────────────────────────────────────────── */
...
/* Visual de la sección «La transformación».
   SUSTITUIR por una foto del showroom de Autonación o de uno de sus
   autos insignia en cuanto la agencia la comparta. */
...
const ideas = [
  {
    num: "01",
    title: "Serie «Entrega sin espera»",
    desc:
      "Video cinematográfico de cada entrega — el momento en que el cliente recibe las llaves de su Porsche, su GT-R, su Raptor. Nadie más en Puebla tiene ese inventario; nadie más puede grabar esas escenas.",
  },
  {
    num: "02",
    title: "Inventario a nivel publicitario",
    desc:
      "Sesión de foto y video profesional para cada auto de alto valor. Un Ferrari se anuncia como Ferrari.",
  },
  {
    num: "03",
    title: "Remarketing sobre su audiencia actual",
    desc:
      "Millones ya vieron sus videos — campañas que persiguen específicamente a quien vio, comentó o preguntó, hasta convertirlo en cita.",
  },
  {
    num: "04",
    title: "Captura en Google",
    desc:
      "Quien busca «seminuevos de agencia Puebla» o un modelo específico, aterriza en una landing suya, no en MercadoLibre junto a la competencia.",
  },
  {
    num: "05",
    title: "Filtro inteligente por WhatsApp",
    desc:
      "Bot que califica presupuesto, modelo y forma de pago, para que su equipo hable solo con compradores reales — a la velocidad que promete la marca.",
  },
];
...
const colaboracion = [
  {
    ...
    title: "Inmersión",
    desc:
      "Conocemos su operación, su inventario y sus objetivos por sucursal.",
  },
  {
    num: "02",
    title: "Plan conjunto",
    desc:
      "Definimos juntos prioridades, calendario y metas — la estrategia sigue siendo suya, nosotros ponemos la maquinaria.",
  },
  {
    num: "03",
...
const traccion = [
  {
    ...
    desc:
      "El que vio su video tres veces recibe el empujón que le faltaba.",
  },
  {
    title: "Google Ads para capturar demanda activa",
    desc:
      "Quien busca «seminuevos de agencia» o un modelo específico, los encuentra a ustedes.",
  },
  {
    title: "Optimización de Google Maps",
    desc: "Para dominar las búsquedas locales en cada sucursal.",
  },
  {
    title: "Landing page a la altura de su inventario",
    desc: "Diseñada para convertir visitas en citas.",
  },
  {
    title: "Sistema de bots que califica cada lead",
    desc:
      "Presupuesto, modelo, forma de pago — su equipo solo habla con compradores reales.",
  },
  {
    title: "Carruseles con fotografía profesional",
    desc:
      "Que hacen justicia a un inventario que no cualquiera tiene.",
  },
];
...
export default function PropuestaAutonacionClient() {
      ...
      <main style={{ background: "#1C1C1A", color: "#E4E0DD" }}>
            ...
            <div className="overflow-hidden max-w-[1100px]">
              ...
              >
                ...
                <em style={{ color: "#D63A27", fontStyle: "italic" }}>
                  Nosotros convertimos compradores.
                </em>
              </motion.h1>
            </div>
          </div>
        ...
        <section className="relative px-6 md:px-14 py-24 md:py-40 max-w-[1400px] mx-auto">
          <motion.div {...reveal} className="max-w-[880px]">
            ...
            <Body className="mb-7">
              {CLIENTE} ya ganó la parte difícil: construyó una audiencia de
              millones y un inventario que no cualquiera tiene. Pero mover una
              operación así deja poco espacio para lo demás — producir cada auto
              a nivel publicitario, perseguir con campañas al que ya mostró
              interés, atender cada mensaje a la velocidad que la marca promete.
            </Body>
            <Body>
              Y un Ferrari en el inventario merece una producción a la altura del
              auto.
            </Body>
          </motion.div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
              <motion.div {...reveal} className="lg:col-span-6">
                ...
                <Body>
                  ...
                  operando como extensión del tuyo: cada auto del inventario
                  fotografiado y filmado a nivel publicitario, campañas que
                  persiguen al que ya mostró interés, un bot que filtra curiosos
                  y entrega solo compradores calificados.
                </Body>
              </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            <motion.div {...reveal} className="lg:col-span-6">
              ...
              <Body>
                ...
                puntuales. Cuando vendes autos de siete cifras, cada pieza tiene
                que verse como lo que vendes.
              </Body>
            </motion.div>
        ...
        >
          ...
          <div className="relative z-10 max-w-[1000px] mx-auto text-center">
            ...
            >
              El inventario ya lo tienen.
              <br />
              La audiencia ya la construyeron.
            </motion.h2>
